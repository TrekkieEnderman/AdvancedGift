...
public class V1_21_R5 implements NMSInterface {
    ...
    @SuppressWarnings("deprecation") // Spigot #getKeyOrNull() does not exist in Paper API.
    private @Nullable String getKey(ItemStack item) {
