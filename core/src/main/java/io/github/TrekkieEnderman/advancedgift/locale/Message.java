...
public enum Message {
    ...
    BLOCK_LIST_USAGE_1("giftBlockListCommandUsage1"),
    BLOCK_LIST_USAGE_2("giftBlockListCommandUsage2"),
    ...
    COMMAND_GIFT_USAGE_1("giftCommandUsage1"),
    COMMAND_GIFT_USAGE_2("giftCommandUsage2"),
